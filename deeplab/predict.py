...
if __name__ == "__main__":
    ...
    name_classes = ["background", "cable"]
    #------------------------------------------------/home/amax/Public/TJD_CODE/deeplabv3-plus-pytorch-main/deeplabv3+_mobilenetv2_77.16/best_epoch_weights.pth----------------------------------------------------------#
    ...
    #-------------------------------------------------------------------------#
    dir_origin_path = "D:\Cursor\Project\project\deeplab\img"
    dir_save_path = "D:\Cursor\Project\project\deeplab\img"
    #-------------------------------------------------------------------------------------------#
